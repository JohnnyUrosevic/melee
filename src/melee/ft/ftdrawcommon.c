...
s32 lbl_804D3A88 = -128;
s32 lbl_804D3A90 = 8421631;
s32 lbl_804D3A8C = 8421504;

extern void (*lbl_803C20CC[33])(HSD_GObj*, s32, void*);
...
// https://decomp.me/scratch/wbs6Q 81.44%
asm void func_800805C8(HSD_GObj* gobj, u32 arg1, u32 arg2) {
    nofralloc
    ...
    lbl_80080864:
    /* 80080864 0007D444  80 82 89 8C */	lwz r4, lbl_804D836C
    /* 80080868 0007D448  7F 87 E3 78 */	mr r7, r28
    /* 8008086C 0007D44C  80 02 89 90 */	lwz r0, lbl_804D8370
    ...
    /* 80080B0C 0007D6EC  C3 E2 89 88 */	lfs f31, lbl_804D8368
    ...
    /* 80080B28 0007D708  48 2E 97 61 */	bl func_8036A288
    ...
    /* 80080B40 0007D720  C0 02 89 88 */	lfs f0, lbl_804D8368
    ...
    /* 80080B94 0007D774  48 2E FE 49 */	bl func_803709DC
    /* 80080B98 0007D778  80 9F 00 04 */	lwz r4, 4(r31)
    /* 80080B9C 0007D77C  3C 60 80 3C */	lis r3, lbl_803C20CC
    /* 80080BA0 0007D780  38 03 20 CC */	addi r0, r3, lbl_803C20CC
    ...
    /* 80080C00 0007D7E0  48 2E FD DD */	bl func_803709DC
    lbl_80080C04:
...
// https://decomp.me/scratch/sjQ3z 98.95%, just a reg swap but I can't figure it out
asm void func_80080C28(HSD_GObj* gobj, s32 arg1) {
    nofralloc
    ...
    /* 80080D0C 0007D8EC  C3 E2 89 88 */	lfs f31, lbl_804D8368
    ...
    /* 80080D28 0007D908  48 2E 95 61 */	bl func_8036A288
    ...
    /* 80080D40 0007D920  C0 02 89 88 */	lfs f0, lbl_804D8368
    ...
    /* 80080D90 0007D970  48 2E FC 4D */	bl func_803709DC
    /* 80080D94 0007D974  80 9F 00 04 */	lwz r4, 4(r31)
    /* 80080D98 0007D978  3C 60 80 3C */	lis r3, lbl_803C20CC
    /* 80080D9C 0007D97C  38 03 20 CC */	addi r0, r3, lbl_803C20CC
    ...
    /* 80080DFC 0007D9DC  48 2E FB E1 */	bl func_803709DC
    lbl_80080E00:
