...
void lbl_8012C59C(void) {
    if (!func_80099794()) {
        return;
    }
}

void lbl_8012C5C0(void) {
    func_80092E10();
}

void lbl_8012C5E0(void) {
    func_80092E30();
}

extern f64 lbl_804D9A30;
void func_80093240();
void func_800932DC();

#pragma push
asm unk_t func_8012C600()
{ // clang-format off
    nofralloc
func_8012C600:
...
/* 8012C630 00129210  C0 22 A0 4C */	lfs f1, lbl_804D9A2C(r2)
/* 8012C634 00129214  83 E3 00 2C */	lwz r31, 0x2c(r3)
/* 8012C638 00129218  FC 60 08 90 */	fmr f3, f1
/* 8012C63C 0012921C  C0 42 A0 48 */	lfs f2, lbl_804D9A28(r2)
...
/* 8012C69C 0012927C  C0 02 A0 48 */	lfs f0, lbl_804D9A28(r2)
...
/* 8012C704 001292E4  80 8D AE B4 */	lwz r4, p_ftCommonData(r13)
...
/* 8012C714 001292F4  C8 62 A0 50 */	lfd f3, lbl_804D9A30(r2)
/* 8012C718 001292F8  90 01 00 60 */	stw r0, 0x60(r1)
/* 8012C71C 001292FC  C0 22 A0 48 */	lfs f1, lbl_804D9A28(r2)
...
/* 8012C754 00129334  C0 02 A0 4C */	lfs f0, lbl_804D9A2C(r2)
